...
const questions = ref([
  ...
  {
    id: 2,
    content: 'Phân tích tác phẩm "Chiếc thuyền ngoài xa" của Nguyễn Minh Châu',
    category: 'Văn',
    difficulty: 'Khó',
    grade: 12,
    hasImage: false,
  ...
  {
    id: 4,
    content: 'Tính khối lượng riêng của nước ở 20°C',
    category: 'Lý',
    difficulty: 'Dễ',
    grade: 8,
    hasImage: true,
  ...
  {
    id: 5,
    content: 'Viết phương trình phân ly của axit H₂SO₄ trong nước',
    category: 'Hóa',
    difficulty: 'Trung bình',
    grade: 10,
    hasImage: false,
  ...
  {
    id: 7,
    content: 'Nêu đặc điểm của thể thơ lục bát trong văn học Việt Nam',
    category: 'Văn',
    difficulty: 'Trung bình',
    grade: 9,
    hasImage: false,
  ...
  {
    id: 8,
    content: 'Translate: "I am learning Vietnamese"',
    category: 'Anh',
    difficulty: 'Trung bình',
    grade: 8,
    hasImage: false,
  ...
  {
    id: 9,
    content: 'Tính áp suất tại đáy một bể nước sâu 3m',
    category: 'Lý',
    difficulty: 'Khó',
    grade: 11,
    hasImage: true,
  ...
  {
    id: 10,
    content: 'Cân bằng phương trình: Fe + O₂ → Fe₂O₃',
    category: 'Hóa',
    difficulty: 'Dễ',
    grade: 9,
    hasImage: false,
  ...
  {
    id: 12,
    content: 'So sánh hai nhân vật chính trong truyện "Vợ nhặt"',
    category: 'Văn',
    difficulty: 'Khó',
    grade: 11,
    hasImage: false,
